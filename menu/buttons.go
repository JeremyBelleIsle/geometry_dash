...
func InitButtons(buttons *[]Button, pauseImg, menuPlayButton, resumeButton, menuButton, nextLevelButton *ebiten.Image) {
	*buttons = []Button{
		...
		{x: level.ScreenWidth / 2, y: level.ScreenHeight / 2, hitBox_X: level.ScreenWidth / 2, hitBox_Y: level.ScreenHeight / 2, place: "gameMenu", utility: "nextLevel"},
	}
}
